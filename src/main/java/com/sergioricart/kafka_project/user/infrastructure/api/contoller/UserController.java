...
import com.sergioricart.kafka_project.user.infrastructure.database.UserEntityMapper;
...
public class UserController {
    ...
    public ResponseEntity<?> deleteUser(@PathVariable String id) {
        ...
        UserDeletedEvent userDeletedEvent =UserDeletedEvent.newBuilder()
                .setId(id)
                .setTimestamp(System.currentTimeMillis())
                .build();

        kafkaProducer.send(topic, userDeletedEvent);
