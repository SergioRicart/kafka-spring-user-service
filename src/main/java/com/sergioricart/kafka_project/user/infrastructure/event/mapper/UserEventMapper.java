...
public interface UserEventMapper extends MapperUtils {
    ...
    UserCreatedCommand mapToUserCreatedCommand(UserCreatedRequest createdRequest);

    CreateUserCommand mapToCreateUserCommand(UserCreatedRequest createdRequest);
